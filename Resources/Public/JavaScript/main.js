(function () {
  ...
  jQuery(function ($) {
    ...
    var setThirdMenuPosition = function setThirdMenuPosition() {
    ...
    setThirdMenuPosition(); // Cleanup function to clean unneeded classes
  ...
  jQuery(function ($) {
    ...
    if (navbar.length) {
      var offsetTop = navbar.offset().top; // function that calculates offsetTop-value.

      var calcOffsetTop = function calcOffsetTop() {
        if (window.matchMedia('(min-width: 992px)').matches) {
  ...
  jQuery(function ($) {
    ...
    $languageMenuBtn.on('click', function (e) {
      ...
      $languageMenuOverlay.addClass('_language-menu-box-overlay-visible'); // hide meta-navigation if showHeaderTopLangMenu = 1
    ...
    $(document).ready(function () {
      ...
      $elem.each(function () {
        ...
        slider.container.on('focus', 'a', function (e) {
          ...
          var focusIndex = $(e.target).parents('.swiper-slide').index(); // Reset scrollLeft set by browser on focus

          slider.container.scrollLeft(0); // IE fix

          setTimeout(function () {
            slider.container.scrollLeft(0);
          }, 0); // Slide to focused slide
  ...
  (function ($) {
    ...
    $(document).ready(function () {
      ...
      if (!$('html').hasClass('IE')) {
        ...
        // disabled parallax in IE since scrolling looks jerky
        $('.parallax-img').jarallax({
          type: 'scroll',
          // scroll, scale, opacity, scroll-opacity, scale-opacity
          speed: 0.5,
  ...
  (function ($) {
    ...
    $(document).ready(function () {
      var $frame = $('.js__hero-image'); // var $slider = $('.slider-container')
  ...
  (function ($) {
    ...
    $(document).ready(function () {
      if ($('.slider-container').length > 0) {
        var $swiperContainerWrapper = $('.js__slider-container__wrapper'); // dividing content into sliders
        ...
        $swiperContainer.each(function () {
          ...
          slider.container.on('focus', 'a', function (e) {
            // Index of focused slide
            var focusIndex = $(e.target).parents('.slider-container__slide').index(); // Reset scrollLeft set by browser on focus
  ...
  (function ($) {
    ...
    $(document).ready(function () {
      $('.carousel').each(function () {
        ...
        var $btn = $this.find('.carousel__btn'); // Set tabindex on quicklinks on init

        $quickLinks.attr('tabindex', 0); // add handler to quickLinks to allow changing the slide via enter key
  ...
  (function ($) {
    ...
    var searchSuggestFn = function searchSuggestFn() {
      // ============================
      ...
      $('[data-search="searchSuggest"]').each(function (index, el) {
        ...
        $(this).on('keyup.search.suggest', function (e) {
          ...
          var fetchSuggestData = function fetchSuggestData() {
            if (!req) {
              req = true;
              $.ajax({
